...
export function GithubStars() {
  ...
  return (
    <Link
      ...
      className="inline-flex items-center gap-1.5 h-8 px-2.5 text-sm font-medium text-text-secondary hover:text-text bg-surface border border-border hover:border-text-muted rounded-md transition-all duration-200"
